...
module.exports = {
    ...
    refreshRoute: async (req, res, next) => {
        try {
            ...
            return res
                .cookie("token_id", tokenId, { origin: true, httpOnly: true, sameSite: "Lax", secure: true /* secure: process.env.NODE_ENV === "production" ? true : false */ })
                .cookie("refreshed_token", token, { origin: true, httpOnly: true, sameSite: "Lax", secure: true /* secure: process.env.NODE_ENV === "production" ? true : false */ })
