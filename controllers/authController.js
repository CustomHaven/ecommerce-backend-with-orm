...
module.exports = {
    ...
    loginRoute: async (req, res, next) => {
        try {
            ...
            // __cf_bm
            return res
                .cookie("__cf_bm", "", { origin: true, domain: "", httpOnly: true, maxAge: 1000, sameSite: process.env.NODE_ENV === "production" ? "None" : "Lax", secure: process.env.NODE_ENV === "production" ? true : false })
    ...
    refreshRoute: async (req, res, next) => {
        try {
            ...
            return res
                .cookie("__cf_bm", "", { origin: true, httpOnly: true, domain: "", maxAge: 1000, sameSite: process.env.NODE_ENV === "production" ? "None" : "Lax", secure: process.env.NODE_ENV === "production" ? true : false })
